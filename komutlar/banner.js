...
exports.run = async (client, message, args) => {
       ...
       let uid = user.id // let uid = message.mentions.users.first() || client.users.cache.get(args[0]) || message.author; = x !
        ...
        let receive = ''
        let banner = `<a:iptal:982407033854754816> **|** <@${user.id}> **Bu Kişinin Banner'ı Yok!**`
        ...
        banner = `<a:successful:982734530274271262> **|** **<@${user.id}>'nin Banner'ı** https://cdn.discordapp.com/banners/${uid}/${receive}.gif?size=1024`
        if(statut === 415) {
        banner = `<a:successful:982734530274271262> **|** **<@${user.id}>'nin Banner'ı** https://cdn.discordapp.com/banners/${uid}/${receive}.png?size=1024`
        }
